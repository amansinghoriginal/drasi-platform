...
beforeAll(async () => {
  ...
  dbPortForward = new PortForward("sk-qdrant-postgres", 5432, "default");
  ...
  console.log("Qdrant accessible at port", qdrantPort);
  ...
  signalrFixture = new SignalrFixture(["sk-qdrant-products-query", "sk-qdrant-products-category-query"]);
...
describe("Qdrant Vector Store E2E Tests", () => {
  ...
  test("Insert operations - Single row", async () => {
    ...
    const insertPromise = signalrFixture.waitForChange("sk-qdrant-products-query",
  ...
  test("Update operations - Simple update", async () => {
    ...
    const updatePromise = signalrFixture.waitForChange("sk-qdrant-products-query",
      change => change.op === "u" && 
  ...
  test("Update operations - Join query cascade", async () => {
    ...
    const updatePromise = signalrFixture.waitForChange("sk-qdrant-products-category-query",
      change => change.op === "u" && 
  ...
  test("Delete operations - Single row", async () => {
    ...
    const deletePromise = signalrFixture.waitForChange("sk-qdrant-products-query",
  ...
  test("Delete operations - Cascade delete in join", async () => {
    ...
    const deletePromise = signalrFixture.waitForChange("sk-qdrant-products-category-query",
