...
public class VectorStoreService : IVectorStoreService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            // Use the adapter to get or create the collection - no reflection needed!
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            // Use the adapter's strongly-typed UpsertAsync method - no reflection needed!
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            // Use the adapter's strongly-typed DeleteAsync method - no reflection needed!
    ...
    public async Task<bool> CollectionExistsAsync(string collectionName, CancellationToken cancellationToken = default)
    {
        try
        {
            // Use the adapter to check collection existence - no reflection needed!
